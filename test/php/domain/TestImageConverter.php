...
require_once(dirname(__FILE__) . '/../../../php/domain/ImageConverter.class.php');

class TestImageConverter extends TraildevilsUnitTestCase 
{
	protected $conv;
	
	function __construct() 
	{
		parent::__construct("Traildevils - TestImageConverter");
	}

	function setUp() 
	{
		$this->conv = new ImageConverter();
	}

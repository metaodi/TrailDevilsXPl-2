...
class DataLoader
{
	...
	public function getTrails($url="http://152.96.80.18:8080/api/trails?\$skip=10&\$top=10&\$orderby=TrailId") /*http://jenkins.rdmr.ch/php/mock_api.json*/
	{
	...
	public function convertJson($externalTrailJson) {
		...
		for($i = 0; $i < count($externalTrailArray); $i++) {
			...
			$convertedArray[$i]["distance"] = $i*100;
